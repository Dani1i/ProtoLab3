...
type ConsultarVanguardiaLunaClient interface {
	ConsultarVanguardiaLuna(ctx context.Context, in *Consulta, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *consultarVanguardiaLunaClient) ConsultarVanguardiaLuna(ctx context.Context, in *Consulta, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type ConsultarVanguardiaLunaServer interface {
	ConsultarVanguardiaLuna(context.Context, *Consulta) (*Empty, error)
...
func (UnimplementedConsultarVanguardiaLunaServer) ConsultarVanguardiaLuna(context.Context, *Consulta) (*Empty, error) {
